...
// TODO: this ChunkOrder tests OG chunks lifecyle which is very differnet in NG
// keep this TODO here so in end-to-end tests, we will add very different life cycle tests
// that inlcude verify catalog content and data
